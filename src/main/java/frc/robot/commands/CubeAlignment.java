...
public class CubeAlignment extends CommandBase {
    ...
    public CubeAlignment(
        ...
        camera = visionSubsystem.getLimelight();
        ...
        if (camera.hasLimelightRawAngles() && atAngle) {
            ...
            if (Math.abs(bestCurrentTarget.tx()) < howCloseGotten + 10) {
                ...
                if (Math.abs(strafeController.getPositionError()) <= 2.0) {
                    lightsSubsystem.setPattern(LightsSubsystem.green);
                } else {
                    lightsSubsystem.setPattern(LightsSubsystem.yellow);
                }
            ...
            lightsSubsystem.setPattern(LightsSubsystem.blue);
        }
